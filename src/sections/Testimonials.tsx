...
export const TestimonialsSection = () => {
  return <div className="py-16 lg:py-24">
    ...
    <SectionHeader eyebrow="What Clients Say" title="Happy Clients" description="dont just take my word for it. See what my clients have to say." />
  ...
  {testimonials.map((testimonial) => (
    <Card className="max-w-xs p-6 md:p-8 md:max-w-md hover:-rotate-3 transition duration-300" key={testimonial.name}>
